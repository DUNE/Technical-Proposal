...
using a McPherson\footnote{\url{http://mcphersoninc.com}.} VUV monochromator with deuterium lamp source to study performance at \SI{127}{nm}. The full plates were too large for the sample chamber
