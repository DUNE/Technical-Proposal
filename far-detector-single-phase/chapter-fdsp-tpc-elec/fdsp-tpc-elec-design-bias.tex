...
As described in Section~\ref{sec:fdsp-apa-design}, the filtering of wire-bias voltages
and AC coupling of wire signals passing
...
signals to the CE motherboards.  A schematic diagram of the APA wire bias subsystem is illustrated in Figure~\ref{fig:CR-board}.
