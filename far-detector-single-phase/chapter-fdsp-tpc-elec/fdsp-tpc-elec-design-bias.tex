...
Each CR board includes single R-C filters for the $X$- and $U$-plane wire bias voltages. In addition, each board has \num{48} 
...
Clamping diodes limit the input voltage received at the amplifier circuits to between \SI{1.8}{V}\,$\pm$\,U$\_$D, where U$\_$D
