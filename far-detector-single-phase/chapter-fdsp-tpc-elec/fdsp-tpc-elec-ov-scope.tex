...
\begin{dunefigure}
[Connections between the signal flanges and APA. Only the upper APA of the hanging APA pair, described in Section~\ref{SOMEWHERE IN THE APA SECTION}, and its connection paths are shown. The lower APA will share the PD flange with the upper APA but have a separate TPC readout flange. ]
{fig:connections}
{Connections between the signal flanges and APA. Only the upper APA of the hanging APA pair, described in Section~\ref{SOMEWHERE IN THE APA SECTION}, and its connection paths are shown. The lower APA will share the PD flange with the upper APA but have a separate TPC readout flange. }
