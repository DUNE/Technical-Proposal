The SLAC CRYO \dword{asic} differs from the baseline three-chip design in that it combines the functions of an analog preamplifier, \dword{adc} and data serialization/transmission, for \num{64}~wire channels, into a single chip.
