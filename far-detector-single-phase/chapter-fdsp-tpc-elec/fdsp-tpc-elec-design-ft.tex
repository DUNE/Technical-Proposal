...
\dword{lv} power is passed from the signal flange to the \dword{femb} by bundles of
...
For a single \dword{femb}, the resistance is measured to be  <\SI{30}{\milli\ohm} at RT or $<10$~m$\Omega$ at 
\lar temperature. Each \dword{apa} has a copper cross section of approximately %$80~\mathrm{mm}^2$ 
\SI{80}{mm$_2$}, with a 
resistance <\SI{1.5}{\milli\ohm} at RT or $<0.5$~m$\Omega$ at \lar temperature.
