...
consortia, followed by those with the \dword{pds}, \dword{hv}, and \dword{cisc} consortia. One of the most
...
\dword{ce} readout of the anode planes. The flanges on the chimneys are used to provide,
...
interfaces to the \dwords{apa} and \dword{daq}, are discussed in more detail.
