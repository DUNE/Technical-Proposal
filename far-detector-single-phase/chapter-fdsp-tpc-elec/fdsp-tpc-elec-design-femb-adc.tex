...
The ADC ASIC is designed for low-noise operation. The noise specification is 175 $\mathrm{\mu}$V-rms. This noise specification was chosen to ensure that LArASIC will dominate the overall noise performance of the channel.
