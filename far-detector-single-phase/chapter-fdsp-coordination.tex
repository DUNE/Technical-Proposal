...
components of the \dword{dune} far detector. There are three consortia
...
control (CISC).  \dword{dune} Technical Coordination, under the
direction of the \dword{dune} Technical Coordinator, has the
...
projects. Groups of institutes within \dword{dune} form consortia that
...
\begin{figure}[htb]
  ...
  \end{center}
\end{figure}
The scope of the intgegration and installation effort is shown
...
Construction of the \dword{dune} Detector
