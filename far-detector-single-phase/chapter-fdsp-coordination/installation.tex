...
integration and installation. On the surface TC is responsible for coordinating with
...
and their associated infrastructure face a number of significant
...
the surface near the Sanford Lab Ross Shaft. One possible mitigation
for risks associated with these factors is the establishment of a DUNE
...
\item {\bf Outreach:} The ITF may be well located to support a public
  outreach program. The DUNE Experiment is likely to generate
  considerable public interest and addressing those interests is
  important to long-term public support for DUNE specifically and
  particle physics generally.
\end{itemize}
...
\item{\bf Cryogenics Systems:} The cryogenics systems are also an LBNF
  ...
  components.
\item{\bf Cryostat Support Structure:} The Cryostat Support Structure
  is the steel frame that provides the lateral force to hold the
  cryostat walls in place and the vertical force to support the cover
  plate. This structure is also an LBNF responsibility and will likely
  be addressed similarly to the Cryostats and the Cryogenic
  Systems. One possible difference is that the steel work may require
  painting at or near the ITF facility, thus requiring a painting
  booth with adequate materials handling and ventilation
  infrastructure.
...
A reasonable criterion for the location of the ITF is within about a
