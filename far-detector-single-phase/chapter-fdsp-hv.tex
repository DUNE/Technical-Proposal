...
in each resistor chain.  Additionally, the voltage of the \dwords{gp} above and below each drift region can be equipped to diagnose problems via a high-value resistor connecting the \dword{gp} to the cryostat.  In the \dword{35t} prototype, such instrumentation provided useful information on \dword{hv} stability and where any stray charge was flowing.
...
7& \dword{hv} System& & \\
7.1& Finalize SP field cage design& 06/27/18& 09/30/19 \\
7.2& Finalize SP cathode design& 06/27/18& 09/30/19 \\
7.3& Run \dword{sp} \dword{hv} Design Integration Test& 01/01/19& 12/31/19 \\
7.4& \dword{hv} TDR - Submit for Internal Review& 03/29/19& 03/29/19 \\
7.5& CPA Procurement& 09/21/21& 12/06/22\\
7.6& Ground Planes Procurement& 08/08/22& 12/06/22\\
7.7& Assemble \& test Voltage dividers& 08/08/22& 12/06/22\\
