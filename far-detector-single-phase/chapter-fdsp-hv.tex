...
for which other designs have used transformer oil or Ultra-high-molecular weight Polyethelene (UHMW-PE).  The outer case of the filter is a grounded stainless-steel shell. A proposed filter design is shown in Figure~\ref{fig:filterAndFeedthrough}.\fixme{Anne: what will we use?}
...
\includegraphics[width=0.3\textwidth]{pdFilters-optim} %Anne reduced size of pdf
...
indicates the location of the current-drawing feature as either upstream or downstream of it.  Experience from a 35t installation suggested sensitivities to changing currents with a time scale between 0.1-10s us providing information on the time scale of any current changes.
