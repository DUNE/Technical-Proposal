...
Platinum sensors with \SI{100}{\ohm} resistance (PT100 series), produced by Lakeshore will be used except for the membrane sensors that may come from Minco.
...
giving excellent results.  As shown in Fig.~\ref{fig:sensor_cable}, the PT102 sensor has a length of \SI{21}{mm},
which can easily be accommodated in the DUNE T-gradient monitors. 
...
For the readout cables a custom cable made by Axon is the baseline (Fig.~\ref{fig:sensor_cable}-Right). It consists in four teflon-jacketed (extruded PFA)
...
which helps in minimizing convection. The capsule is introduced in a PLA box with two concentrical independent volumes of LAr and sourounded by a polystire box with 15 cm thick walls
...
inside fully covering the sensors. Once the temperature stabilizes to the 1 mk level (after 5-15 minutes) measurements are taken. Then the capsule is taken out from LAr
...
\fixme{add figure showing the resolution of the reproducibility of the calibration}
\fixme{add figure of the mechanical structure}
...
\begin{dunefigure}[]{fig:sensor_on_pcb}
  ...
  \includegraphics[width=0.30\textwidth]{cisc_DTSensorMount.png}
\end{dunefigure}
