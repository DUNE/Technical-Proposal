...
a comprehensive monitoring for all detector components as well as for the \dword{lar} quality and behavior, both being crucial
...
studies using \dfirst{cfd}. E-field simulations
...
Electron lifetime measurement precision
 & $<\SI{1.4}{\%}$ at \SI{3}{ms}
 & Per DUNE-FD Task Force, needed to keep the bias on the charge readout in the \dshort{tpc} to below \SI{0.5}{\%} at \SI{3}{ms}
...
needed. In the case of \dword{lar} Instrumentation Devices (purity monitors,
