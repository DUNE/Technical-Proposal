...
The design of the DUNE \dword{spmod} presented in this document
...
is deep in the UV spectrum, can be recorded by \dwords{pd} that shift the
...
A novel feature of the %\single \lartpc 
\dword{hv} system is the use of resistive panels for the \dwords{cpa}, which serves to control the flow of stored energy in this system in the event of an unexpected electrical discharge.  This feature provides protection to the \dword{spmod} elements and guards against damage that would negatively impact detector performance.  
