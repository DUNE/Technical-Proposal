...
\begin{dunefigure}[APA dimensions]{fig:tpc_apa_frame}{An drawing of an APA frame showing the main components. }
\includegraphics[width=\textwidth, angle=90]{APAFrameDimensions} 
\end{dunefigure}

\begin{dunefigure}[APA frame]{fig:tpc_apa_frame_cartoon}{An APA frame showing overall dimensions.}
...
\begin{dunefigure}[APA mesh application]{fig:tpc_apa-meshapplication}{Left: mesh being clamped to the APA. Right: mesh being taped off, ready for gluing.}
...
\begin{dunefigure}[APA side boards]{fig:tpc_apa_sideboardmodel}{Side boards with traces that connect wires around openings.  The wires are wound straight over the openings, then soldered to pads at the ends of the traces.  After soldering the sections between the pads are trimmed away.}
