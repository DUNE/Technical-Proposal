...
\fixme{Can we include the other detectors (or at least PDS) in this figure for clarity, with dotted lines to demark the DAQ scope?  The SP TPC is a special case...  Also, the figure includes a bunch of terms that are not defined in the caption.}
