...
Only the 480 collection channels associated with each \dword{apa} face are
...
Each \dword{trigprimitive} represent ionization activity localized
...
further processing may be done still at the \dword{apa} level and which
...
\dwords{cob} per \dword{apa} which will require a redistribution of fibers. 
