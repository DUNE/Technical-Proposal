...
as a component of the DUNE \dword{tdr} now in development.  Additionally, with 
...
will reflect what is documented within the \dword{cdr} unless otherwise noted. In addition, the following section describes the status of the simulation and reconstruction strategies used to assess the physics requirements for DUNE.
...
$\delta_{\rm CP} = 0 $ with a precision better than $10^\circ$ is \SI{250}~\ktMWyr{} or about  %five 
six and a half years of operation.  
A full-scope LBNF/DUNE operating with 
multi-megawatt 
...
discovery potential for CP violation, as seen in Figure~\ref{fig:execsummaryCP}. To reach this level of sensitivity 
...
Physics milestone & Exposure  & Exposure \\ \rowtitlestyle
  ...
  9 \\ \colhline
  CPV at $3\sigma$ 75\% of \deltacp & 775 & 12.5\\  \colhline
  Reactor $\theta_{13}$ resolution & 857 & 13.5 \\   
...
capabilities.  Given the 1-GeV energy release, the requirements on tracking and calorimetry 
...
%The DUNE FD will be sensitive to other nucleon decay modes, such as $p\to \pi^0 e^+$. 
%but in many cases the sensitivity will not exceed that of Super-Kamiokande.
