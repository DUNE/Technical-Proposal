...
will be a very large modular liquid argon time-projection chamber (LArTPC) located deep underground. This detector will be coupled to Fermilab's LBNF multi-megawatt  %power 
...
\begin{itemize}
%  Anne added %% Feb 2018   so it would compile; will fix later
