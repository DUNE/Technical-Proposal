...
\includegraphics[width=0.9\textwidth]{global-retouched.png}  %{global.jpg}  replace image for improved greyscale printing
\label{fig:map}
\end{dunefigure}
...
improvement in discovery sensitivity over current searches for the proton lifetime.'' The strategy and design presented in this \dword{tp} meet these requirements.
...
The DUNE experiment includes a precision near detector at the edge of the \fnal site, in Batavia, Illinois, and a very large, modular far detector about \SI{1.5}{km} underground at \surf in Lead, South Dakota, \SI{1300}{km} (\SI{800}{miles}) from \fnal. The DUNE far detector is the focus of this \dword{tp}. 
...
\end{itemize}
The plans for the single and dual-phase TPCs are described in detail in Volumes 2 and 3 of this \dword{tp}.
...
\includegraphics[width=0.68\textwidth]{lbnf_dune_org-new.png}  %{lbnf_dune_org.jpg} update organizational chart for consistency
%\label{fig:mhexec}
\end{dunefigure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The DUNE Interim Design Report Volumes}
