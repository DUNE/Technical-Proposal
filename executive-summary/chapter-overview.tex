...
will enable the accelerator to drive the new neutrino beamline with %a beam power of up to \pipiibeampower{}. %\footnote{assuming a \SI{120}{\GeV} primary proton beam. For 
a \SI{80}{\GeV} primary proton beam at a beam power %from \SI{1.07}{\MW} 
...
\item  the civil construction (\dword{cf}) for the near detector systems at \fnal; (see Figure~\ref{fig:beamline}; 
...
\begin{dunefigure}[Neutrino beamline and DUNE near detector hall at Fermilab
]{fig:beamline}{Neutrino beamline and DUNE near detector hall at Fermilab}
\includegraphics[width=0.95\textwidth]{figures/beamline-sideview.jpg}

\end{dunefigure}

\begin{dunefigure}[ 	
Underground caverns for  at SURF]{fig:caverns}{Underground caverns for DUNE far detectors and cryogenic systems at SURF}
...
\includegraphics[width=0.9\textwidth]{lbnf_dune_org.png}
%\label{fig:mhexec}
\end{dunefigure}
