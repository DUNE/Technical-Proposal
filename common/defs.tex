...
\def\larmass{\SI{17.5}{\kt} % full mass in cryostat
\def\tpcheight{\SI{12.0}{\meter} % height of SP TPC, APA, CPA and of DP TPC

% Parameters SP
\def\spactivelarmass{\SI{10}{\kt} % active mass in cryostat
\def\spmaxdrift{\SI{3.53}{\m}
\def\sptpclen{\SI{58}{\meter} % length of SP TPC, APA, CPA
\def\apacpapitch{\SI{2.32}{\meter} % pitch of SP CPAs and APAs
\def\spfcmodlen{\SI{3.5}{\m} % length of SP FC module

\def\uvpitch{\SI{4.669}{\milli\meter}
\def\xgpitch{\SI{4.790}{\milli\meter}
\def\planespace{\SI{4.75}{\milli\meter}

% Parameters DP
\def\dpactivelarmass{\SI{12.096}{\kt} % active mass in cryostat
\def\dpmaxdrift{\SI{12}{\m}
