...
\def\dunelifetime{\SI{20}{yr}\xspace} % nominal operational life time of DUNE experiment

% Parameters SP
\def\spmaxfield{\SI{500}{\volt/per\centi\meter}} % SPfield strength
...
\def\spnumch{\num{384000}\xspace} % total number of readout channels 
...
\def\dpfidlarmass{\SI{10.643}{\kt}\xspace} % active mass in cryostat
