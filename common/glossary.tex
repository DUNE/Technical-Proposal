...
\newduneabbrev{oob}{OOB dispatcher}{out of band trigger command
 ...
 \glspl{fer} in the \gls{detmodule}.}
...
\newduneabbrev{daqpart}{partition}{DAQ partition}{A cohesive and
 coherent collection of DAQ hardware and software working together to trigger and readout some portion of one detector module consisting of some integral number of\glspl{daqfragment}. 
