...
\newduneabbrev{cisc}{CISC}{cryogenics and slow controls}{A DUNE
...
\newduneabbrev{cmb}{CMB}{Configuration Management Plan}{A project
...
\newduneabbrev{pdf}{PDR}{Preliminary Design Review}{A project management device by which an early design is reviewed}
\newduneabbrev{fds}{FDR}{Final Design Review}{A project management device by which a final design is reviewed}
