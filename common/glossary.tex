...
\newduneabbrev{utca}{$\mu$TCA}{Micro Telecommunications Computing
  Architecture}{A computer architecture} 
...
\newduneabbrev{amc}{AMC}{Advanced Mezzanine Card}{An electronics card designed for use with the uTCA system}
...
\newduneword{wrmch}{WR-MCH}{White Rabbit MicroTCA Carrier Hub}
