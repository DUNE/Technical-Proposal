...
% mirrors.ctan.org/macros/latex/contrib/glossaries/glossaries-user.pdf
...
\newcommand{\newduneabbrevs}[5]{
  ...
  % referenced in the text.
  % \newacronym[see={[Glossary:]{#1}}]{abbrev-#1}{#2}{#3}
  \newacronym[longplural=#4]{abbrev-#1}{#2}{#3}
  \newglossaryentry{#1}{
    text={#2},
    long={#3},
%    plural={#4},
...
\newduneword{comfund}{Common Fund}{needs def}
\newduneword{ims}{IMS}{needs def  Steve K in support.tex}
