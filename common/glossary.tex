...
%% \url{https://www.amphenol-icc.com/product-series/micro-tca-card-edge.html}.
\newduneabbrev{utca}{$\mu$TCA}{Micro Telecommunications Computing Architecture}{A computer architecture. Vertical card-edge connectors, Amphenol ICC} %?? needs work
...
\newduneword{daqpart}{DAQ partition}{A cohesive and
 coherent collection of DAQ hardware and software working together to trigger and read out some portion of one detector module consisting of some integral number of\glspl{daqfrag}. 
...
\newduneword{artdaq}{\textit{art}DAQ}{A modern, general-purpose software framework for distributed data combination and processing.}
...
\newduneabbrev{gp}{GP}{ground plane}{An electrode which is held to be
  ...
  \newduneword{gg}{ground grid}{An electrode which is held to be
  electrically neutral relative to Earth ground voltage}
