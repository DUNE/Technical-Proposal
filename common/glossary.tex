...
\newduneabbrev{oob}{OOB dispatcher}{out of band trigger command
  ...
  trigger command to all \glspl{fer} in the \gls{detmodule}}
...
\newduneabbrev{daqpart}{partition}{DAQ partition}{A cohesive and
  coherent collection of DAQ hardware and software working together to
  trigger and readout some portion of one detector module consisting
  of some integral number of \glspl{daqfragment}. 
  Multiple DAQ partitions may operate simultaneously but each instance
...
\newduneabbrev{daqds}{data selector}{The portion of the
  \gls{daqfrag} which accepts \glspl{trigcommand} and returns the
  corresponding \gls{datafrag}}
