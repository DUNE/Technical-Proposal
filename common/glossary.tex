...
\newduneabbrev{rce}{RCE}{Reconfigurable Computing Element}{One of four
  nodes in a \gls{cog} which consists of ARM CPU and FPGA resources. \fixme{Needs improvement}}


\newduneabbrev{cob}{COB}{Cluster On Board}{Four \glspl{rce} together
  with networking an other hardware.\fixme{Needs improvement}}

\newduneabbrev{acta}{ACTA}{ACTA}{A computer platform.\fixme{Needs
    improvement}} 
...
\newduneabbrev{fpga}{FPGA}{Field Programmable Gate Array}{An
  ...
  to execute different algorithms after manufacture. \fixme{Needs improvement}}
...
\newduneabbrev{fec}{FEC}{front-end computer}{Each \gsl{detunit} of a
