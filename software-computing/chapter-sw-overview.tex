...
Cosmic rays in 30 beam days& 2.1 M\\
Planned storage size for cosmic rays during beam period& 0.04 PB\\
Cosmic rays over a 6 month run& 150 M\\
Requested beam storage envelope for \dword{protodune}-DP&0.7 PB \\
Requested overall storage envelope for \dword{protodune}-DP&2.5 PB \\
\end{dunetable}
