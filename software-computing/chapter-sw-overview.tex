...
Table \ref{daq:datarates} summarizes the data rates expected from the DAQ systems.
...
If decision can be made to read or not read out the detector based on internal information, data volumes can be substantially reduced.  
