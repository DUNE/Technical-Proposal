...
of the \lartpc{} requires very low noise levels in order that the signal from the drifting ionization \fixme{charge} be clearly discernible over the baseline of the electronics.  This requires use of low-noise cryogenic electronics. 
%
