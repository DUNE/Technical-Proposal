...
It is possible to know the vertical position of the \dword{crp} both from the suspension system and from some dedicated capacitive measurements.
The  suspension system and its motorization on three points provides an accurate measurement for each \dword{crp} of the order of \SI{0.1}{mm} thanks to the accuracy of the steps motors and encoders. 
