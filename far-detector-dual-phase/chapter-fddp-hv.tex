...
The \dword{hv} consortium supplies the systems that operate at the nominal voltages to provide the uniform \SI{500}{\volt/\cm} \efield in the \dword{tpc} drift volume. As a result, its systems %actually 
