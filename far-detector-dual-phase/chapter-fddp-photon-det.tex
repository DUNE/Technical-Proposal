...
Within this table a baseline choice for the R5912-MOD20 \dword{pmt} as manufactured by Hamamatsu Photonics \cite{hamamatsu-5912} is made.}
\footnotesize
%  & & \\
...
Light yield & 2.5 \phel/\si{MeV} & For \dword{pddp}, final value depending on simulation results\\
% 	 & 	 & simulation results \\
\toprowrule
...
\multicolumn{3}{l}{\bf Electrical} \\ \specialrule{1.5pt}{1pt}{1pt}
	...
	\dword{hv} grounding	& Isolated		    & \dword{hv} outputs shall be floating, crate ground is independent of the return of the \dword{hv} channels.	\\
...
\dword{daq} & 6802 \\
%\dword{cisc} & 6781 \\
Cryogenic instrumentation and slow controls (CISC) & 6781 \\ %capitalize first letter dword workaround
DUNE Physics & 7087 \\
