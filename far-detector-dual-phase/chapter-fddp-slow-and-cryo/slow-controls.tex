...
% removed per SG  In the current concept of the \dual detector, \dword{hv} biasing for the \dword{lem}, extraction grid, and \dword{pds} also falls within the scope of slow controls.  This hardware could be assigned to different consortia in the future.  For now its description is provided here.
