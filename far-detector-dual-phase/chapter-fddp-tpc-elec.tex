...
R\&D on this timing distribution solution started in 2006; the final design for integrating this system, foreseen for the \dword{dpmod}, into the \dword{pddp} and the \dword{wa105} readout was completed in 2016. 
...
\begin{dunetable}[DP TPC electronics consortium key milestones]
{ll}
...
March 2019 & Comissioning of \dword{pddp} finished \\ \colhline
