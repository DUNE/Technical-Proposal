...
housed in the underground data room in the \dlong{cuc} (\dshort{cuc}),
...
in Sec.~\ref{sec:fdgen-slow-cryo-sw} will be located in the \dshort{cuc} data
...
available in the \dshort{cuc}'s DAQ server room for CISC usage.
