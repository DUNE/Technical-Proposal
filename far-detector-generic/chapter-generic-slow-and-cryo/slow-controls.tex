...
in Section~\ref{sec:fdgen-slow-cryo-sw} will be located in the \dshort{cuc} data
...
\fixme{lots of ``should'' rather than is or shall. Also, lots of future tense in chap}
...
systems are in place.  The LBNF-\dword{cisc} interface will be managed by the
