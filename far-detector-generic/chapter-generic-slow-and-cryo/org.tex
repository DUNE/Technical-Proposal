...
%as shown in Table~\ref{tab:gen-slow-cryo-org}.  REMOVING NAMES FROM TP
...
\includegraphics[width=0.6\textwidth,trim=20mm 80mm 30mm 70mm,clip]{cisc_org-nonames}  %org chart generated using LaTeX Tikz by DeMuth, no names
\end{dunefigure}
...
% AH IS REMOVING NAMES FROM TP, SO REMOVING THE TABLE: CISC consortium institutions
