...
Since temperature variations inside the cryostat are expected to be very small ($\SI{0.02}{K}$), to properly measure the 3D temperature map 
...
As shown in Figure ~\ref{fig:Trepro} a reproducibility of $\sim \SI{2}{mK}$ has been achieved in the ProtoDUNE-SP design.  
...
\begin{dunefigure}[sensor precision]{fig:Trepro}
...
\begin{dunefigure}[dyn-T-grad]{fig:fd-slow-cryo-dt-monitor-overview}
