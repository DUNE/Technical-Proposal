...
The need of intermediate anchoring points is under discussion. For the DP detector no baseline design exists yet. 
...
As inferred from Fig.~\ref{fig:Trepro} the system has a resolution better than 1 mk (the RMS of one of offsets in the stable region).     
