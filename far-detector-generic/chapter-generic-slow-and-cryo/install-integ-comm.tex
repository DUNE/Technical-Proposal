...
% Email from David, to be properly written
%For the pipes on the floor (and long vertical), we are looking at ways to address the thermal contraction. This will affect the design and the installation.

%It is a work in progress, we have nothing worth presenting/reporting on yet.

%As far as integration, everything being develop so far is in the Cryostat model at CERN, who is currently responsible for the integration of the cryostat,
%detector, proximity cryogenics in the Detector Cavern.

%The commissioning is easy: there is effectively no way to commission any of this before we start the commissioning of the whole thing, meaning after closing the cryostat door,
%obtaining all approvals, etc. The pieces will be tested in sections at the vendor’s site before delivery, but no integrated test/commissioning is possible after the installation.
