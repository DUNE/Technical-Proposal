...
Another important interface is the one with the HV system since several aspects related with safety must be taken into account. 
...
%\fixme{Interfaces with DAQ has to be expanded}
