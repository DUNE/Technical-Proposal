...
The concept of \textit{run} represents a period of time in which the same
...
\fixme{Anne removed: In particular, for such a large and distributed system, it is important to have a well thought through information sharing and archival system, and also to put human resources into the development of scalable and easily accessible data visualization tools, which will evolve during the lifetime of the experiment.}
In particular, for such a large and distributed system, the information sharing and archival system is very important, as are \fixme{Anne removed:  and also to put human resources into the development of }
...
data taking.
\fixme{Anne removed: While it is not involved in physics data flow nor selection, it has a large impact on the \dword{daq}: }
