...
\begin{dunefigure}[DAQ Overview]{fig:daq-overview}
  {The high-level, nominal design for the DUNE FD DAQ showing data
    (solid, with line width indicating throughput) and trigger
    (dashed) flows. 
    The red box and dashed arrows indicate delivery of special trigger
    commands related to \dword{snb}. 
    The data flow related to \dword{snb} is not depicted. 
...
before the data reaches the DAQ \dword{daqbuf}. 
