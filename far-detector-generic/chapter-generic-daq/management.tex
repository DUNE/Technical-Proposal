...
%\metainfo{2 Pages}
At the time of writing, the \dword{daq} consortium comprises \num{30} institutions, including universities and national labs, from five countries. Since its conception, the \dword{daq} consortium has met on roughly a weekly basis, and has so far held two international workshops dedicated to advancing the  \dword{fd} \dword{daq} design. The current \dword{daq} consortium leader is %Dave Newbold, 
from U. Bristol, UK.
