...
\dword{artdaq}, which is a modern, general-purpose software framework for
distributed data combination and processing. 
It has been used in \dword{protodune} and other experiments.
...
back-end computing.
The authors of \dword{artdaq} have accomodated DUNE-specific feature-addition
...
$\frac{3}{8}$'s of the \single data stream from their \dword{daqfrag}. 
