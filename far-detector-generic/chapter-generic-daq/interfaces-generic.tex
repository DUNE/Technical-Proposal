...
summarize the data is the join responsibility of the \dword{daq}, Offline,
Reconstruction and other groups.
The \dword{dqm} system includes a visualization system which can be
...
This will allow bi-directional communications between \dword{daq} and CISC by
...
monitors in \dword{daq} racks will be read out into the CISC data stream.
...
The \dword{daq} will need to save data based on external triggers, for
...
\subsubsection{Astrophysical Triggers:} \dfirst{snews} is a coincidence
