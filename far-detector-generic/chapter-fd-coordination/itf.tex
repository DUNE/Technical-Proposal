...
\dword{dune} \dwords{fd} and their associated infrastructure present
...
\begin{itemize}
  ...
  \item {\bf Component Fabrication:} The fabrication of some
    ...
    of the SURF at the \dword{itf}, taking advantage of
...
The cryostats that will house the \dwords{fd} and the cryogenic
...
\begin{itemize}
  ...
  \item Dedicated clean room on order of 10,000 sq. feet to facilitate
    integration of electronics and photon detectors on \dwords{apa},
    which make up the readout planes of the \dword{sp} \dword{fd}. The
