...
facility. TC will evaluate and accept consortia components either at
integration facilities or the installation site and oversee the
integration of components as appropriate. The scope of the far
detector integration and installation effort is shown graphically in
Fig.~\ref{fig:TC_flow}.
\begin{figure}[htb]
  \begin{center}
...
conventional facilities (CF) design. This includes refining the
