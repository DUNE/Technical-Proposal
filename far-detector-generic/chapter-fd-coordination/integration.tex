...
TC engineering team will work with the \dword{lbnf} project team to
...
For mechanical design aspects, the \dword{dune} TC engineering team
...
full detector models into a global \dword{lbnf} CAD model which will
...
The \dword{dune} Technical Coordination organization will work with
...
project QA and \dword{esh} managers will document quality control and safety
...
altered without approval of the \dword{dune} Technical Coordination
...
\dword{dune} Technical Coordination will work with the consortia,
...
\dword{dune} Technical Coordination staff will facilitate the review,
...
compliance to engineering standards and \dword{esh} concerns.  The
\dword{dune} Technical Coordination staff will assist the consortia in
