...
The \dword{dune} \dword{tc} organization will work with
...
cryogenics are managed through the \dword{dune} \dword{tc}
...
fulfill the requirements of the design.  By the time of the \dword{tdr}, all design requirements must be fully defined and
...
\dword{dune} \dword{tc} will work with the consortia,
...
consultation with the QAM.  The Technical Coordinator and \dword{tc}
