...
\begin{dunefigure}[needs a caption]{fig:Install-Seq1}
  {needs a caption- was too small to read}
\includegraphics[width=.9\textwidth]{Install-ISO-Top.pdf}
\end{dunefigure}

\begin{dunefigure}[needs a caption]{fig:Install-Seq2}
  {needs a caption- was too small to read}
\includegraphics[width=.9\textwidth]{Install-TopView.pdf}
\end{dunefigure}

%% let's see what these look like before replacing them. anne
%
\begin{figure}
\begin{center}
...
detector installation. \fixme{which was built into the cryostat for the installation?} First the missing panel with the steel beams
