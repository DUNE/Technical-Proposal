...
\dword{dune} \dword{tc} organization is shown in Fig.~\ref{fig:TC_orgchart}.
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=\textwidth]{far-detector-generic/figures/TP_TC_Org_Chart}
    \caption{Organization of \dword{tc}. This organization
...
from the consortia construction sites to the the \dword{itf}. \dword{tc} will
...
\dword{tc} has been working with the LBNF/DUNE systems engineering team to
...
and utilities. \dword{tc} is representing the interests of the DUNE detector
