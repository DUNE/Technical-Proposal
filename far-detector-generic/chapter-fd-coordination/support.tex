...
Several major project support tasks need to be accomplished:
\begin{itemize}
...
consortia are fully developed and reviewed and that the requirements on
...
the DUNE DocDB (\url{https://docs.dunescience.org}). DUNE drawings will be
stored in EDMS
...
have been collected on the TCPC webpage. These are being developed into
