...
\begin{dunefigure}[DUNE Technical Board.]{fig:TB_org}
 ...
 \includegraphics[width=0.9\textwidth,trim=20mm 110mm 30mm 110mm,clip]{TB_Org_Chart-new}
\end{dunefigure}
...
\Dword{tc} maintains a web page\footnote{\url{https://web.fnal.gov/collaboration/DUNE/DUNE\%20Project/\_layouts/15/start.aspx\#/}.}
...
can be seen in Table~\ref{tab:DUNE_schedule}. %Figure~\ref{fig:DUNE_schedule}.
...
%\end{dunefigure}       %replace figure by table  - DeMuth
\begin{dunetable}
[Overall \dword{dune} Project Tier-1 milestones.]
...
\Dword{tc} is responsible for reviewing all stages of detector development
and works with each consortium to arrange reviews of the design
(\dword{pdr} and \dword{fdr}), production (\dword{prr} and
\dword{ppr}) and \dword{orr} of their system.  These
...
will be stored in 
\dword{edms}~\footnote{\url{https://edms.cern.ch/ui/\#!master/navigator/project?P:1637280201:1637280201:subDocs}.}.
